Feature: ScanMalta
  ...
  Given I am a user on the website  When I log in using valid credentials "jonathan.cauchi.14@um.edu.mt" and "Logininfo1234"
  ...
  Given I am a logged in user on the website "jonathan.cauchi.14@um.edu.mt" and "Logininfo1234"
