Feature: ScanMalta
  ...
  When I log in using valid credentials "jonathan.cauchi.14@um.edu.mt" and "password"
  Then I should be logged in

  Scenario: 2 Invalid Login
  Given I am a user on the website
  When I log in using invalid credentials "jonathan.cauchi.14@um.edu.mt" and "password"
  Then I should not be logged in

  Scenario: 3 Product Search
  Given I am a logged in user on the website "jonathan.cauchi.14@um.edu.mt" and "password"
